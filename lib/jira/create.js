...
const assembleCreationParameters = async (options) => {
    ...
    const e = {};
    await DynamicPrompt_1.projectPrompt(e, userConfigPrefs);
    // await dynamicPrompt('project', e, userConfigPrefs);
    await DynamicPrompt_1.issueTypePrompt(e);
    // await dynamicPrompt('issueType', e, userConfigPrefs);
    if (e.issueType?.subtask === true)
        await DynamicPrompt_1.parentTaskPrompt(e, userConfigPrefs);
    ...
    await DynamicPrompt_1.askIssueSummaryAndDetails(e);
