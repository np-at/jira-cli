...
const ls_1 = __importDefault(require("./jira/ls"));
...
exports.default = (() => {
    ...
    program
        ...
        .action(options => {
        if (options.project) {
            ls_1.default.showByProject(options, finalCb);
        }
        else {
            ls_1.default.showAll(options, finalCb);
        }
    });
    program
        .command('start <issue>')
    ...
    program
        ...
        if (config_1.default && config_1.default.authNew) {
            const jira = new jira_connector_1.default({
                host: config_1.default.authNew.host,
                // eslint-disable-next-line camelcase
                basic_auth: {
                    base64: config_1.default.authNew.token
                }
            });
            const _create = create_1.default(jira);
