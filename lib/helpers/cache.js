...
exports.fuseProjectIndexOptions = exports.fuseIssueIndexOptions = exports.fuseProjectIndexPath = exports.fuseIssueIndexPath = exports.cacheFilePath = exports.recentsCachePath = exports.HourMilli = exports.cacheDirectory = void 0;
...
exports.recentsCachePath = path_1.default.join(exports.cacheDirectory, '.recents-cache.json');
...
class CacheObject {
    ...
    get recent() {
        this._recentsCache ?? (this._recentsCache = JSON.parse(fs_1.readFileSync(exports.recentsCachePath, { encoding: 'utf-8' })));
        return this._recentsCache.value;
    }
    set recent(entry) {
        this._recentsCache = { updated: Date.now(), value: entry };
        fs.writeFileSync(exports.recentsCachePath, JSON.stringify(this._recentsCache), { encoding: 'utf-8' });
    }
    get _data() {
    ...
    static _ensureCache() {
        try {
            ...
            if (!utils_1.default.isFileExists(exports.recentsCachePath)) {
                fs_1.writeFileSync(exports.recentsCachePath, '{}', { encoding: 'utf-8' });
            }
        }
        catch (e) {
